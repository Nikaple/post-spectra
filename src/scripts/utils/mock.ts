...
Yield 58%; 191.1 mg; red solid; mp 198–200℃; IR (KBr): 1638, 1411, 833,736, cm–1; 1H NMR (600 MHz, CDCl3) δ 8.15 (s, 1H), 8.11 (d, J = 8.4 Hz, 1H), 7.75 – 7.69 (m, 2H), 7.67 (s, 1H), 7.62 (d, J = 8.4 Hz, 1H), 7.43 – 7.33 (m, 5H), 7.11 (t, J = 3.6 Hz, 1H), 2.59 (s, 3H). 13C NMR (150 MHz, CDCl3) δ 186.7, 154.1, 144.4, 143.0, 138.5, 138.2, 137.0, 136.1, 135.5, 134.1, 132.5, 129.3, 128.9, 128.5, 128.4, 128.0, 127.8, 126.5, 21.8. HRMS(ESI): m/z [M + H]+ calcd for C21H16NOS: 330.0947; found: 330.0944.
